...
# 计算神经网络的前向传播结果
def forwardPropagation(input, avg_class, weights1, biases1):
    if avg_class == None:
...
def train(mnist):
    ...
    y = forwardPropagation(x, None, weights1, biases1)    # validation: (5000, 10)
    ...
    average_y = forwardPropagation(x, variable_averages, weights1, biases1)
